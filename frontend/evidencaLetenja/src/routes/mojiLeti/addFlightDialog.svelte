<script lang="ts">
    ...
    export let onSave: (data: { cas_vzleta: string; cas_pristanka: string; id_pilota: number }) => void;
...
<Dialog.Root>
    <Dialog.Trigger class="mt-6 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Dodaj
    </Dialog.Trigger>
    <Dialog.Content class="sm:max-w-[425px]">
        ...
        <div class="grid gap-4 py-4">
            ...
            <div class="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="id_pilota" type="number" bind:value={id_pilota} class="col-span-3" />
            </div>
        </div>
        <Dialog.Footer>
